function init_menu() {
	...
	$('#main_menu_red li ul li a').hover(
		function() {
			$(this).animate({paddingLeft : 18}, 200).css('color','#616161');
		},
		function() {
	...
	$('#main_menu_red > ul > li > ul').prepend('<li class="top"></li>');
	$('#main_menu_red > ul > li > ul > li > ul').prepend('<li class="top"></li>');
